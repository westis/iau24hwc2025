...
export const sv: Translations = {
  ...
  live: {
    ...
    officialLiveStreamLink: "Officiell livestream",
    ...
    weatherNoteHourly: "Timprognos för lopp. Uppdateras var 30:e minut.",
    weatherNote3Hour: "3-timmarsprognos för lopp. Uppdateras var 3:e timme.",
    ...
    newUpdatesAvailable:
      "Nya uppdateringar tillgängliga - Klicka för att uppdatera",
    high: "Hög",
  },
  footer: {
    siteBy: "Sajt av",
