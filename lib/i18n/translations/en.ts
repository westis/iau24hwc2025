...
export const en: Translations = {
  ...
  news: {
    ...
    edited: "edited",
    bannedFromCommenting: "You are banned from commenting",
    like: "Like",
    likes: "Likes",
  ...
  chat: {
    ...
    manageAccountSettings: "Manage your account security and preferences",
  ...
  live: {
    ...
    teamsViewComingSoon: "Teams view coming soon",
    teamsViewDescription:
      "Here you'll be able to see results grouped by country",
    rank: "Rank",
    bib: "Bib",
    runner: "Runner",
    distance: "Distance",
    ...
    lastLap: "Last Lap",
    projected: "Projected",
    lastPassing: "Last Passing",
    lapDetails: "Lap Details",
    lap: "Lap",
    lapTime: "Lap Time",
    lapPace: "Lap Pace",
    raceTime: "Race Time",
    genderRank: "Gender",
    avgPace: "Avg Pace",
    noLapData: "No lap data available",
    loadingLaps: "Loading laps...",
    weatherForecast: "Weather",
    weatherDescription: "Hourly forecast for the race period",
    temperature: "Temperature",
    feelsLike: "Feels Like",
    hourly: "Hourly",
    loadingWeather: "Loading weather...",
    noRunnersFound: "No runners found",
    runnerSelection: "Runner Selection",
    runnerSelectionDesc: "Choose which runners to display on the charts",
    top6Overall: "Top 6 Overall",
    custom: "Custom",
    selected: "Selected",
    runners: "runners",
    ...
    baselineDistance: "Baseline Distance (km)",
    selectRunnersDesc:
      "Select runners from the leaderboard to view their progress",
    noRunnersSelected: "No runners selected",
    ...
    onBreak: "On Break",
    noRunnersOnBreak: "All runners are on the course",
    noRunnersOnTrack: "No runners on track",
    loadingMap: "Loading map...",
    legend: "Legend",
    onCourse: "On Course",
    startFinishLine: "Start/Finish Line",
    progress: "Progress",
    timeSinceLastPass: "Since last pass",
    predictedLapTime: "Est. lap time",
    team: "Team",
    ...
    timeUnitsSeconds: "seconds",
    timeUnitsMinutes: "minutes",
    timeUnitsHours: "hours",
    timeUnitsDays: "days",
    timeUnitsSecond: "second",
    ...
    weatherNoteHourly: "Hourly forecast for race period. Updated every 30 minutes.",
    weatherNote3Hour: "3-hour forecast for race period. Updated every 3 hours.",
