-- Migration: Create/Update teams table
-- Description: Store team-level content (photos, descriptions) for each country

-- First, check if teams table exists and drop it if it does (CAREFUL!)
-- Only run this if you don't have any important data in the teams table
DROP TABLE IF EXISTS teams CASCADE;

-- Now create the teams table fresh
CREATE TABLE teams (
